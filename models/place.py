...
class Place(BaseModel, Base):
    ...
    Inherits from SQLAlchemy Base and links t MySQL table places.

    Attributes:
        __tablename__ (str): The name of MySQL table to store places.
        ...
        max_guest (sqlalchemy Integer): e maximum number of guests.
        price_by_night (sqlalchemy Integer): T price by night.
        latitude (sqlalchemy Float): T place's latitude.
        longitude (sqlalchemy Float): place's longitude.
        reviews (sqlalchemy relationship):e Place-Review relationship.
