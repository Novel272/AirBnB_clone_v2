...
class DBStorage:
    ...
    Attributes:
        __engine (sqlalchemy.Engine): worki SQLAlchemy engine.
    ...
    def all(self, cls=None):
        """Query on  curret database session all objects of  given class.
    ...
    def reload(self):
        """Create tables in database and initialize a new session."""
