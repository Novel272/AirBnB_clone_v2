#!/usr/bin/python3
"""
 the TestFileStorageDocs classes
"""
...
class TestFileStorageDocs(unittest.TestCase):
    """Test check documentation style of FileStorage """
    @classmethod
    def setUpClass(cls):
        """Set up doc tests"""
...
test_file_storage.py'])
    ...
    def test_fs_func_docstrings(self):
        """Test presence of docstrings in FileStorage methods"""
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_all_returns_dict(self):
        """Test returns the FileStorage.__objects attr"""
        storage = FileStorage()
    ...
    @unittest.skipIf(models.storage_t == 'db', "not testing file storage")
    def test_new(self):
        """tests an object to the FileStorage.__objects attr"""
        storage = FileStorage()
    ...
    def test_get_dbstorage(self):
        """Tes storage engine with valid data"""
    ...
    def test_get_dbstorage2(self):
        """Test storage engine with valid data"""
    ...
    def test_count_fstorage_cls(self):
        """test cont method with class name"""
        old_count = models.storage.count()
