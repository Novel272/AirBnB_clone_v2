...
class TestDBStorageDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_db_storage(self):
        """Tests models/engine/db_storage.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_db_storage(self):
        """Teest tests/test_models/test_db_storage.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
...
test_db_storage.py'])
    ...
    def test_db_storage_module_docstring(self):
        """Test db_storage.py module docstring"""
    ...
    def test_db_storage_class_docstring(self):
        """Test DBStorage class docstring"""
    ...
    def test_dbs_func_docstrings(self):
        """Test presence of docstrings in DBStorage methods"""
    ...
    def test_count_fstorage_cls(self):
        """tes count method with class name"""
        old_count = models.storage.count()
